package com.javacourseexercises.lists.exercise01.application;

import com.javacourseexercises.lists.exercise01.entities.Employee;
...
public class Program {
    ...
    private static boolean hasId(List<Employee> list, String id) {
